...
public class vThirdPersonCamera : MonoBehaviour
{
    ...
    public float smoothCameraRotation = 15f;
    ...
    public float smoothFollow = 15f;//10f
    public float xMouseSensitivity = 1.5f;//3f
    public float yMouseSensitivity = 1.5f;//3f
    public float yMinLimit = 0f;//-40f
    ...
    private float clipPlaneMargin = 3f;//0f
